...
<main id="main-content">
  ...
  <section class="page-header has-divider">
    <div class="container">
      ...
      <h1>Home Renovation & Landscaping in <span class="text-accent">Henrico County</span>, VA</h1>
  ...
  <section class="bg-alt">
    <div class="container" data-animate="fade-up">
      ...
      <span class="section-subtitle--accent">Full-service renovation across the West End</span>
      ...
      <div class="grid-3" data-stagger>
        <a href="/services/kitchen-remodeling" class="card card-tint-1" style="text-decoration:none;">
        ...
        <a href="/services/bathroom-remodeling" class="card card-tint-2" style="text-decoration:none;">
        ...
        <a href="/services/bedroom-remodeling" class="card card-tint-3" style="text-decoration:none;">
        ...
        <a href="/services/laundry-room-remodeling" class="card card-tint-neutral" style="text-decoration:none;">
        ...
        <a href="/services/common-area-remodeling" class="card card-tint-1" style="text-decoration:none;">
        ...
        <a href="/services/patio-porch-terrace-construction" class="card card-tint-2" style="text-decoration:none;">
        ...
        <a href="/services/greenscape-landscape-design" class="card card-tint-3" style="text-decoration:none;">
        ...
        <a href="/services/irrigation-design-installation" class="card card-tint-neutral" style="text-decoration:none;">
        ...
        <a href="/services/lawn-care-maintenance" class="card card-tint-1" style="text-decoration:none;">
        ...
        <a href="/services/design-services" class="card card-tint-2" style="text-decoration:none;">
  ...
  <section class="bg-alt">
    <div class="container" data-animate="fade-up">
      ...
      <div class="related-services">
        ...
        <a href="/service-areas/hanover-county" class="related-chip card-tint-3">Hanover County</a>
